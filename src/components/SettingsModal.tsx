            ...
            <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 space-y-3">
              ...
              <div className="flex gap-2">
                <select 
                  ...
                  className="flex-1 min-w-0 px-3 py-2 text-sm bg-white border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-700"
                  defaultValue=""
                >
